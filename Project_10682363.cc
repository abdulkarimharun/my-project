...
case '3'://course biodata
{ 
while(1)//inner loop-2
{ 
system("cls");//Clear screen
//Level-2 Display process
cout<<"\t\t\t COURSE INFORMATION AND BIODATA SECTION\n\n\n";
cout<<"Enter your choice: "<<endl;
cout<<"1.add courses\n";
cout<<"2.edit courses\n";
...
switch (choice)//fourth  switch
{
case '1'://Insert data
{ 
ofstream t1("course.txt",ios::app);
